function [alphaArray, pedalPressureArray, gearArray, vArray, brakeTemperatureArray] = ...
    DriveTruckTest(chromosome, numberOfHiddenNeurons, GetSlopeAngleFunction)
% Constants
