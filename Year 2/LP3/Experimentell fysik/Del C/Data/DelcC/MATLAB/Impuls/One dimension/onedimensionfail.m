function coefficients = onedimensionfail(path, mass1, mass2)
% load('Z:\.win\My Documents\Impuls\Data\1D\Gummiband\En_stilla_1.tsv')
data=load(path);
pos_x_1 = data(:,1);
pos_x_2 = data(:,4);
time=[0:0.002:0.002*(length(pos_x_2)-1)]
