...
rotenergydividedbyvel1 = k*(r_21_min/2)^2*(omega_12^2)/(vel_11)/1000;
theta = acos(b/(r_21_min/1000))
analysis = [transenergycoeff, b, vel_rel, rotenergy, rotenergydividedbyvel1, theta, r_21_min];
