...
%******* Fält i Plan 1
f_lins=1000e-3; % fokallängd på linsen före Plan 1
...
E1_cirkular=E_in_konstant.* T_lins .* T_apertur; % Fältet i Plan 1 (precis efter linsen) för konstant fält som passerat genom cirkulär apertur 
