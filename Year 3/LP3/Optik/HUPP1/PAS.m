...
fasfaktor_propagation=exp(1i*kzmat*L); % faktorn varje sampelpunkt i k-planet (som ju motsvarar plan våg i viss riktning) multas med för att propagera sträckan L i z-led

A= a^2/(2*pi)*fft2c(E1); % Planvågsspektrum i Plan 1
