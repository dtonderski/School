...
public class Quick {
     ...
     */
	  ...
	  public static void sort(int[] a) { // To do: try randomising the array before
	  sorting. StdRandom.shuffle(a); sort(a, 0, a.length - 1); assert isSorted(a);
	  }
    ...
    private static int partition(int[] a, int lo, int hi) {
    	...
    	//exch(a, median3(a, lo, (hi+lo)/2, hi), lo);
